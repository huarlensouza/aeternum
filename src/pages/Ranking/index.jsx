    ...
    return (
        <ThemeProvider theme={darkTheme}>
            ...
            <Dialog
                ...
                maxWidth={'sm'}
            >
                <DialogTitle id="scroll-dialog-title">Histórico de Combate</DialogTitle>
                <DialogContent dividers={true}>
                    <DialogContentText
                        component="div"
                    >
                        {duels.map((value, index) => (
                            <Box key={index} sx={{pt:1, borderBottom: index !== duels.length-1 ? '1px solid #ffffff0d' : 'none'}}>
                                ...
                                <Box sx={{display:'flex', flexDirection:'row', justifyContent:'space-between'}}>
                                    ...
                                    <Box sx={{width:'42%', display:'flex', flexDirection:'row', alignItems:'flex-start'}}>
                                        ...
                                        <Box sx={{ml:{lg:1, md:1, sm:1, xs:0}}}>
                                            <Box>
                                                <Typography sx={{lineHeight:1, color:value.winner == 1 ? '#95ed95' : '#e28f8f', fontSize:{lg:'16px', md:'16px', sm:'16px', xs:'12px'}}}>{value.nickname}</Typography>
                                            </Box>
                                    ...
                                    <Box sx={{width:'16%', display:'flex', flexDirection:'row', alignItems:'center', justifyContent: 'center', ml:1, mr: 1}}>
                                    ...
                                    <Box sx={{width:'42%', display:'flex', flexDirection:'row-reverse', alignItems:'flex-start'}}>
                                        ...
                                        <Box sx={{mr:{lg:1, md:1, sm:1, xs:0}}}>
                                            <Box sx={{textAlign:'end'}}>
                                                <Typography sx={{lineHeight:1, color:value.winner == 1 ? '#e28f8f' : '#95ed95', fontSize:{lg:'16px', md:'16px', sm:'16px', xs:'12px'}}}>{value.opponent}</Typography>
                                            </Box>
